				...
				<form action="" method="post" id="reg">
					...
					<ul>
						...
						<li>
							...
							<input type="text" class="txt" value="" name="User[mobile]" id="mobile" placeholder="请输入有效手机号！"/>
						</li>
						<li>
							<label for="">验证码：</label>
							<input type="text" class="txt" value="" placeholder="请输入短信验证码" name="User[captcha]" disabled="disabled" id="captcha"/>
						...
						<li>
							<label for="">&nbsp;</label>
							<input type="btn" value="" class="login_btn" />
						</li>
					</ul>
				</form>
